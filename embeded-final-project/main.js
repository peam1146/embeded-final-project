...
(function () {
  (function () {
    ...
    randomize = function (data) {
      ...
      for (var i = 0; i < l; i++) {
        if (
          isNaN(data[i][0].value) ||
          isNaN(data[i][1].value) ||
          isNaN(data[i][2].value) ||
          isNaN(data[i][3].value)
        ) {
        } else {
          //Change dust
          if (!dustC && dustL == -1) {
...
// console.log(toggle1);
if (toggle1 === 0) {
  document.getElementById("Toggle").style.color = "black"; //play music
  document.getElementById("Toggle").innerText = "Close";
  document.getElementById("Toggle").style.fontFamily = "Source Code Pro";
} else if (toggle1 === 1) {
  document.getElementById("Toggle").style.color = "black"; //pause music
...
function Toggle() {
  if (toggle1 === 0) {
    document.getElementById("Toggle").style.color = "black"; //play
    document.getElementById("Toggle").innerText = "Open";
    document.getElementById("Toggle").style.fontFamily = "Source Code Pro";
    toggle1 = 1;
    writeUserData(1);
  } else if (toggle1 === 1) {
    document.getElementById("Toggle").style.color = "black"; //pause
    document.getElementById("Toggle").innerText = "Auto";
    document.getElementById("Toggle").style.fontFamily = "Source Code Pro";
    toggle1 = -1;
    writeUserData(-1);
  } else if (toggle1 === -1) {
    document.getElementById("Toggle").style.color = "black"; //stop
    document.getElementById("Toggle").innerText = "Close";
    document.getElementById("Toggle").style.fontFamily = "Source Code Pro";
    toggle1 = 0;
    writeUserData(0);
